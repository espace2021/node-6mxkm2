...
export const createArticle = async (req, res) => {
  const { reference, designation,prixAchat,prixVente,prixSolde,marque,qtestock,caracteristiques,imageartpetitf,imageartgrandf,categorieID,scategorieID} = req.body;
    ...
    const newArticle = new Article({ reference, designation,prixAchat,prixVente,prixSolde,marque,qtestock,caracteristiques,imageartpetitf,imageartgrandf,categorieID,scategorieID} )
